...
FORMAT="${FORMAT:-both}"
PARAM_SETS="${PARAM_SETS:-LMS_SHA256_M32_H5+LMOTS_SHA256_N32_W4,LMS_SHA256_M32_H10+LMOTS_SHA256_N32_W4}"
MSG_SIZES="${MSG_SIZES:-32,256,1024,4096}"
ITERATIONS="${ITERATIONS:-100}"
WARMUP_RUNS="${WARMUP_RUNS:-3}"
RUNS="${RUNS:-5}"
OPERATIONS="${OPERATIONS:-keygen,sign,verify}"
ALG_NAME="${ALG_NAME:-LMS}"
LIB_NAME="${LIB_NAME:-lms-signature}"
...
Example:
  BENCH_CMD='cargo run --release --bin lms_bench --' \
