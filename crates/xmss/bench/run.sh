...
FORMAT="${FORMAT:-both}"
PARAM_SETS="${PARAM_SETS:-XMSS-SHA2_10_256,XMSS-SHA2_16_256,XMSS-SHA2_20_256}"
MSG_SIZES="${MSG_SIZES:-32,256,1024,4096}"
ITERATIONS="${ITERATIONS:-100}"
WARMUP_RUNS="${WARMUP_RUNS:-3}"
RUNS="${RUNS:-5}"
OPERATIONS="${OPERATIONS:-keygen,sign,verify}"
ALG_NAME="${ALG_NAME:-XMSS}"
LIB_NAME="${LIB_NAME:-xmss-rust}"
...
Example:
  BENCH_CMD='cargo run --release --bin xmss_bench --' \
